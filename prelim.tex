...
For example, given a degree-3 vertex $u$ with dangling edge $e$ shown in Figure \ref{fig:G} , the result of $e_1 - u$ is shown in Figure \ref{fig:e-u} and the result of $G-e-u$ is shown in Figure \ref{fig:G-e-u}.
