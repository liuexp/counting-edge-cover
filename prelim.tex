...
In this paper, we deal with an extended notion of graphs where dangling edges and free edges may be allowed.
\begin{Def}
...
For a graph $G=(V,E)$ and a normal edge $e=(u,v) \in E$, let $G-e \triangleq (V, E-e)$, and $G-v \triangleq (V-\set{v}, E-e)$.
