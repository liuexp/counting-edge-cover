...
\begin{Thm}
	...
	\[ 1- \epsilon \leq \frac{Z(G)}{Z(G, L)} \leq 1+ \epsilon\]
\end{Thm}
...
\begin{proof}
	...
	Since $1-P(G_i,e_i) \geq \frac{1}{2}$,
	\[ \frac{\abs{P(G_i, e_i, L) - P(G_i,e_i)}}{1 - P(G_i,e_i)} \leq \frac{\epsilon}{2m}\]
	
	Namely $\forall i$,
	\[ \left( 1 - \frac{\epsilon}{2m} \right) \leq \frac{1-P(G_i, e_i, L)}{1 - P(G_i,e_i)} \leq \left( 1 + \frac{\epsilon}{2m} \right)\]
	So we have
	\[ \left( 1 - \frac{\epsilon}{2m} \right)^m \leq \prod_{i=1}^m \frac{1-P(G_i, e_i, L)}{1 - P(G_i,e_i)} \leq \left( 1 + \frac{\epsilon}{2m} \right)^m\]
	\[ 1- \epsilon \leq \frac{Z(G)}{Z(G, L)} \leq 1+ \epsilon\]
...
the total running time is $O(m \cdot ( m\cdot n \cdot \frac{1}{\epsilon})^ {\log_2 6} )$.
