...
\begin{equation}
	P(G,e) = \frac{\abs{EC(G-e)}}{\abs{EC(G-e)} + \abs{EC(G-e-u-v)} }.
\end{equation}
	...
	Denote $Z_{\boldsymbol\alpha, \boldsymbol\beta}^G \triangleq \abs{EC_{\boldsymbol\alpha, \boldsymbol\beta}(G)}$, $G_1 \triangleq G-e, G_2 \triangleq G-e-u-v$. As an illustration, given a normal edge $e=(u,v)$ in $G$ as in Figure \ref{fig:generalG}, $G_1$ and $G_2$ are Figure \ref{fig:generalG-e} and Figure \ref{fig:generalG-e-u-v} respectively.
